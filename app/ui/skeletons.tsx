            ...
            <div className="inline-block min-w-full align-middle">
                <div className="rounded-lg bg-gray-50 p-2 md:pt-0">
                    ...
                    <table className="hidden min-w-full text-gray-900 md:table">
                        <thead className="rounded-lg text-left text-sm font-normal">
                            <tr>
                                <CustomersTableTableHeader label="Name" />
                                <CustomersTableTableHeader label="Email" />
                                <CustomersTableTableHeader label="Total Invoices" />
                                <CustomersTableTableHeader label="Total Pending" />
                                <CustomersTableTableHeader label="Total Paid" />
                            </tr>
                        </thead>
                        <tbody className="bg-white">
